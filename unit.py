...
def unit_converter():
    ...
    while True:
        print("\nSelect an option:")
        print("1. Temperature Converter (Celsius to Fahrenheit / Fahrenheit to C
        ...
        if choice == '1':
            ...
            try:
                value = float(value)
                source_unit = input("Enter source unit (C for Celsius / F for Fa
                if source_unit == 'C':
            ...
            try:
                value = float(value)
                source_unit = input("Enter source unit (M for Meters / F for Fee
                if source_unit == 'M':
            ...
            try:
                value = float(value)
                source_unit = input("Enter source unit (K for Kilograms / P for
                if source_unit == 'K':
